...
import com.hoanghai.ecommerce.multivendor.api.enums.PaymentOrderStatus;
...
import com.hoanghai.ecommerce.multivendor.api.repositorys.PaymentOrderRepository;
                ...
                .addLineItem(SessionCreateParams.LineItem.builder()
                        ...
                        .setPriceData(SessionCreateParams.LineItem.PriceData.builder()
                                ...
                                .setProductData(SessionCreateParams.LineItem
                                        .PriceData.ProductData.builder().setName("Payment")
                                        .build())
                                .build())
                        .build())
                .build();
