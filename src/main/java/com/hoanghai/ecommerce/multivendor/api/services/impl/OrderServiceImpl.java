...
import com.hoanghai.ecommerce.multivendor.api.repositorys.AddressRepository;
import com.hoanghai.ecommerce.multivendor.api.repositorys.OrderItemRepository;
import com.hoanghai.ecommerce.multivendor.api.repositorys.OrderRepository;
...
public class OrderServiceImpl implements OrderService {
    ...
    public Order cancelOrder(Long orderId, User user) throws Exception {
        ...
        if(user.getId().equals(order.getUser().getId())) {
            throw new Exception("Your don't have access to this order");
        }
